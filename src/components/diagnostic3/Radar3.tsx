...
/*
 * Radar du Diagnostic 3 : deux tracés superposés, le ressenti (pointillés)
...
export default function Radar3({ valeurs }: { valeurs: Partial<Record<PillarId, { ressenti: number; preuves: number }>> }) {
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <RadarChart cx="50%" cy="50%" outerRadius="76%" data={data}>
        ...
        <Radar name="Preuves" dataKey="preuves" stroke="#1e2d7d" strokeWidth={2} fill="#00d4b4" fillOpacity={0.18} isAnimationActive />
      </RadarChart>
    </ResponsiveContainer>
  );
}
